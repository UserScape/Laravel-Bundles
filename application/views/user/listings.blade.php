		...
		<table class="table zebra-striped">
			@foreach ($bundles->results as $bundle)
				<tr class="status_{{$bundle->active}}">
					<td>
						<h3><a href="{{URL::to('bundle/'.$bundle->uri.'/edit')}}">{{$bundle->title}}</a></h3>
					...
					<td>
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li><a href="{{URL::to('bundle/'.$bundle->uri)}}" class=""><i class="icon-zoom-in"></i> Preview</a></li>
								<li><a href="{{URL::to('bundle/'.$bundle->uri.'/edit')}}"><i class="icon-pencil"></i> Edit</a></li>
								<li class="divider"></li>
								<li class="remove">
